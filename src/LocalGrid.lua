...
-- The exact solid tests live in Solid, shared with the global grid.
local Solid = require(script.Parent:WaitForChild("Solid"))
local boxOverlap, isBlock, supportHalf = Solid.boxOverlap, Solid.isBlock, Solid.supportHalf
local wedgeOverlap, isWedge = Solid.wedgeOverlap, Solid.isWedge
